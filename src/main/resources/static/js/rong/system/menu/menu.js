                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (item, index) {
                            ...
                            if (item.type === 2) {
                                return '<span class="layui-btn layui-btn-warm layui-btn-xs">按钮</span>';
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        valign: 'center',
                        formatter: function (item, index) {
                            var e = '<a class="layui-btn layui-btn-normal layui-btn-xs'
                                // + s_edit_h
                                + '" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                + item.id
                                + '\')"><i class="layui-icon layui-icon-edit"></i></a> ';
                            var p = '<a class="layui-btn layui-btn layui-btn-xs'
                                // + s_add_h
